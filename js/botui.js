		...
		za = function(i) {
			...
			function x(n, r, i, o, a) {
				for (var s, u, l, f, p = 0, d = 0, v = r.length - 1, h = r[0], m = r[v], g = i.length - 1, _ = i[0],
					...
					d]) : (e(s) && (s = Kt(r, p, v)), u = t(_.key) ? s[_.key] : null, e(u) ? (c(_, o, n, h.elm),
					_ =
...
function bot_ui_ini() {
	...
	var sure = function() {
		...
		secondpart = function() {
			botui.message.add({
				delay: 1500,
				content: "是个苦逼的带学生天天不知道在忙什么"
			}).then(function() {
				botui.message.add({
					delay: 1500,
					content: "正在学前端同时被算法摧残"
				}).then(function() {
					botui.action.button({
						delay: 1100,
						action: [{
		...
		thirdpart = function() {
			botui.message.add({
				delay: 1E3,
				content: "这是以hexo为基础用了大佬做好的主题Sakura搭建在github上的"
			}).then(function() {
				botui.message.add({
					delay: 1100,
					content: "说人话就是我只是搭建了，再加上我的一丢丢前端基础能魔改一点"
				}).then(function() {
					botui.message.add({
						delay: 1200,
						content: "比如这一串对话就是改的人家的"
					}).then(function() {
						botui.message.add({
							delay: 700,
		...
		fourthpart = function() {
			botui.message.add({
				delay: 2000,
				content: "还有什么想问的一起来了吧"
			}).then(function() {
				botui.action.button({
					delay: 1500,
					action: [{
						text: "“沙滩海语，雾林间缘”是什么意思啊",
						value: "sl"
					}, {
						text: "你喜欢什么呀？",
						value: "like"
